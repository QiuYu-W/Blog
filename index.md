...
<div class="home">
  ...
  <section class="recent-posts">
    ...
    {% endfor %}
    <a href="{{ '/blog/' | relative_url }}" class="btn">查看更多 →</a>
  </section>
  ...
  <section class="research-highlights">
    ...
    <ul>
      ...
      <li>最新论文：<a href="{{ '/research/' | relative_url }}">查看详情</a></li>
    </ul>
    <a href="{{ '/research/' | relative_url }}" class="btn">查看详情 →</a>
  </section>
  ...
  <section class="projects-highlights">
    ...
    <a href="{{ '/projects/' | relative_url }}" class="btn">查看更多项目 →</a>
  </section>
</div>
